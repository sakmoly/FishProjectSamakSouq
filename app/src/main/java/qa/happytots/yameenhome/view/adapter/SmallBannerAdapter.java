...
import qa.happytots.yameenhome.retrofit.Retrofit_Models.SmallBannerData;

public class SmallBannerAdapter extends PagerAdapter {

    private ArrayList<SmallBannerData> IMAGES;
    private LayoutInflater inflater;
    private Context context;


    public SmallBannerAdapter(Context context, ArrayList<SmallBannerData> IMAGES) {
