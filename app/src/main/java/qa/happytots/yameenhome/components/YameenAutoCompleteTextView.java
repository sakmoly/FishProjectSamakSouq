...
public class YameenAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    public YameenAutoCompleteTextView(Context context) {
        super(context);
    }

    public YameenAutoCompleteTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
